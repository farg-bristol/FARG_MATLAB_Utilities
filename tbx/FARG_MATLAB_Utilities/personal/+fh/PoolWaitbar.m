classdef PoolWaitbar < handle
    %%% POOLWAITBAR implements a waitbar for parrallel process
    %%% taken from Edric Ellis post in the forum https://uk.mathworks.com/
    %%% matlabcentral/answers/465911-parfor-waitbar-how-to-do-this-more-cleanly
